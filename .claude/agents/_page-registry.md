...
| `/settings` → Über/Rechtliches | [`lib/screens/about_screen.dart`](../../lib/screens/about_screen.dart) | smoke-theme, mobile-overflow | Über-/Copyright-Seite: App-Name + Version (`package_info_plus`), Copyright „© 2026 Kerem Özkan", „Alle Rechte vorbehalten". Vollbild-Push aus Einstellungen → Allgemein (`AboutScreen`). |

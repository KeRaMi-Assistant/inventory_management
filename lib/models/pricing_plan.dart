  ...
  static const List<PricingPlan> all = <PricingPlan>[
    ...
    PricingPlan(
      ...
      highlights: [
        ...
        'Volle Statistik (Drilldowns, Heatmaps, Trends)',
    ...
    PricingPlan(
      ...
      category: PricingCategory.personal,
      tagline: 'Power-Solo & Power-Buchhaltung',
      ...
      highlights: [
        ...
        'Volle Statistik + Forecast + Cashflow-Prognose',
        'DATEV-Export & Steuerberater-Sharing',

...
class PricingPlan {
  ...
  static const List<PricingPlan> all = <PricingPlan>[
    ...
    PricingPlan(
      ...
      category: PricingCategory.personal,
      tagline: 'Solo-Reseller, alles drin',
      ...
      highlights: [
        ...
        'Volle Statistik (Drilldowns, Heatmaps, Trends, Cashflow)',
    ...
    PricingPlan(
      plan: BillingPlan.soloPro,
      category: PricingCategory.personal,
      tagline: 'Power-Solo, mehr Bestand, mehr Speicher',
      monthlyPriceEur: 14.99,
      yearlyPriceEur: 149.90,
      vatIncluded: true,
      mostPopular: true,
      productLimit: 25000,
      dealsPerMonthLimit: unlimited,
      ...
      highlights: [
        'Bis zu 25.000 Produkte (5× mehr als Solo)',
        'Unbegrenzt Deals',
        '1 Postfach · 14 Tage Inbox-Verlauf',
        'Mail-Auto-Detect für 15+ Shops (Amazon, MediaMarkt, eBay, …)',
        '15 Bilder pro Eintrag · 50 GB Storage',
        'Volle Statistik (Drilldowns, Heatmaps, Trends, Cashflow)',
    ...
    PricingPlan(
      ...
      highlights: [
        ...
        '1 Postfach · 14 Tage Inbox-Verlauf',
        'Mail-Auto-Detect für 15+ Shops (Amazon, MediaMarkt, eBay, LEGO, Kaufland, …)',
        'Workspace-Einladungen mit Owner/Admin/Member-Rollen',
        'Activity-Log über alle Team-Aktivitäten',
        'E-Mail-Support (24h)',
      ],
    ),
    PricingPlan(
      ...
      highlights: [
        ...
        '5 Postfächer · 30 Tage Inbox-Verlauf',
        'Mail-Auto-Detect für 15+ Shops',
        'Workspace-Einladungen mit Rollen-Verwaltung',
        'Activity-Log über alle Team-Aktivitäten',
        'API & Webhooks (geplant)',
        'Priority-E-Mail-Support (12h SLA)',
      ],
    ),
    PricingPlan(
      ...
      highlights: [
        ...
        '15 Postfächer · 30 Tage Inbox-Verlauf',
        'Mail-Auto-Detect für 15+ Shops',
        'Workspace-Einladungen mit Rollen-Verwaltung',
        'Activity-Log über alle Team-Aktivitäten',
        'API & Webhooks (geplant)',
        'SSO + White-Label (geplant)',
        'Dedizierter Account-Kontakt',

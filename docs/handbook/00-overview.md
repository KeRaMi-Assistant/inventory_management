...
| Retrack Single Deal | Deal-Detail → Refresh-Icon | Sofort-`tracking-poll`-Call, 30s-Cooldown pro Deal | [`lib/services/supabase_repository.dart`](../../lib/services/supabase_repository.dart) (`retrackDeal`) + [`lib/providers/inventory_provider.dart`](../../lib/providers/inventory_provider.dart) |
